...
def _resource_path(nome_arquivo: str) -> str:
    """
    Retorna o caminho absoluto do arquivo,
    compatível com .py e .exe (PyInstaller).
    """
...
class App:
    def __init__(self):
        # Registra o AppUserModelID para o Windows exibir
        # o ícone correto na barra de tarefas
        try:
            ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID(
                "Quality.MigradorTitulosPagar.1.0"
            )
        except Exception:
            pass
        ...
        # Aplica o ícone na janela e na barra de tarefas
        try:
            icone_path = _resource_path("icone.ico")
